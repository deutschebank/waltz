...
import static org.finos.waltz.common.FunctionUtilities.always;
...
@RestController
public class LicencesExtractorController {

    private final ApplicationIdSelectorFactory applicationIdSelectorFactory = new ApplicationIdSelectorFactory();
    private final DSLContext dsl;

    @Autowired
    public LicencesExtractorController(DSLContext dsl) {
        this.dsl = dsl;
    }

    @GetMapping(value = "/data-extract/licences/{kind}/{id}")
    public Object getLicencesForEntity(
        ...
        SelectConditionStep<Record7<Long, String, String, String, Timestamp, String, String>> qry = dsl
                ...
                .where(SOFTWARE_USAGE.APPLICATION_ID.in(appIdSelector));
