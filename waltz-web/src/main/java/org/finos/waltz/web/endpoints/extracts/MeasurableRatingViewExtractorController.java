...
@RestController
@RequestMapping("/data-extract/measurable-rating-view/")
public class MeasurableRatingViewExtractorController {
    ...
    @Autowired
    public MeasurableRatingViewExtractorController(MeasurableRatingViewService measurableRatingViewService,
    ...
    @PostMapping("category-id/{categoryId}")
    public void getViewForParentAndCategory(@RequestBody MeasurableRatingViewParams viewParams,
        ...
        writeReportResults(response, prepareRatings(viewParams, categoryId, parseExtractFormat(request), fileName));
    }
