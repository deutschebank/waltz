...
@RestController
@RequestMapping("/api/bulk-upload-legal-entity-relationships/")
public class BulkUploadLegalEntityRelationshipController {

    private static final Logger LOG = LoggerFactory.getLogger(BulkUploadLegalEntityRelationshipController.class);
    ...
    @Autowired
    public BulkUploadLegalEntityRelationshipController(BulkUploadLegalEntityRelationshipService service,
    ...
    @PostMapping("resolve")
    public ResolveBulkUploadLegalEntityRelationshipResponse resolveRoute(@RequestBody BulkUploadLegalEntityRelationshipCommand uploadCmd,
                                                                         Principal principal) {
    ...
    @PostMapping("save")
    public SaveBulkUploadLegalEntityRelationshipResponse saveRoute(@RequestBody BulkUploadLegalEntityRelationshipCommand uploadCmd,
                                                                   Principal principal) {
        String username = principal.getName();
        ensureUserHasAdminRights(uploadCmd.legalEntityRelationshipKindId(), username);
        LOG.info("User: {} saving bulk upload: {}", username, uploadCmd);
