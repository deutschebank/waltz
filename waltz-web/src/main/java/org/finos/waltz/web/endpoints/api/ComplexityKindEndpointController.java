...
@RestController
@RequestMapping("/api/complexity-kind/")
public class ComplexityKindEndpointController {
    ...
    @Autowired
    public ComplexityKindEndpointController(ComplexityKindService complexityKindService) {
        this.complexityKindService = complexityKindService;
    }

    @GetMapping
    public Set<ComplexityKind> findAll() {
        return complexityKindService.findAll();
    }
}
