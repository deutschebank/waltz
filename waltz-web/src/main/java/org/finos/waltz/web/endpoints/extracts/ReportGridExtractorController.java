...
@Controller
@RequestMapping("/data-extract/report-grid/")
public class ReportGridExtractorController {
    ...
    @Autowired
    public ReportGridExtractorController(DynamicCommaSeperatedValueFormatter dynamicCommaSeperatedValueFormatter,
    ...
    @GetMapping("external-id/{externalId}/definition")
    public ReportGridDefinitionJSON handleReportGridDefinitionByExternalId(@PathVariable("externalId") String externalId) {
    ...
    @PostMapping("external-id/{externalId}")
    public Object handleReportGridByExternalId(@PathVariable("externalId") String externalId,
                                             @RequestBody IdSelectionOptions selectionOptions,
                                             @RequestParam(value = "format", defaultValue = "CSV") ExtractFormat format,
