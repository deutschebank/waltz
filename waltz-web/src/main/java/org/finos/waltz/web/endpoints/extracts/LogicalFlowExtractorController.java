...
@RestController
@RequestMapping("/data-extract/logical-flows/")
public class LogicalFlowExtractorController {
    ...
    @Autowired
    public LogicalFlowExtractorController(DSLContext dsl) {
        this.dsl = dsl;
    }


    @PostMapping()
    public void register(@RequestBody IdSelectionOptions options,
