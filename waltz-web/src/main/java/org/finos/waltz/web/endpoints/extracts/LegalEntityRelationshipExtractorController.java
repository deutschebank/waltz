...
@RestController
@RequestMapping(LegalEntityRelationshipExtractorController.BASE_URL)
public class LegalEntityRelationshipExtractorController {

    public static final String BASE_URL = "/data-extract/legal-entity-relationship/";
    ...
    @Autowired
    public LegalEntityRelationshipExtractorController(DSLContext dsl,
    ...
    @PostMapping("relationship-kind/{id}")
    public void legalEntityRelationshipViewExtract(HttpServletRequest request, HttpServletResponse response,
                                                   @PathVariable("id") long relKindId,
                                                   @RequestBody IdSelectionOptions selectionOptions,
                                                   @RequestParam(value = "format", defaultValue = "XLSX") ExtractFormat format) throws IOException {
        writeReportResults(
                response,
                prepareRows(
                        format,
