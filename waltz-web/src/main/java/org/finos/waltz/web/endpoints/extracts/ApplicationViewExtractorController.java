...
public class ApplicationViewExtractorController {

    private final ApplicationViewService applicationViewService;
    private final OrganisationalUnitService orgUnitService;

    @Autowired
    public ApplicationViewExtractorController(ApplicationViewService applicationViewService,
    ...
    public Object findBySelector(@RequestBody IdSelectionOptions options,
                                 HttpServletRequest request,
                                 HttpServletResponse response) throws IOException {
        return writeReportResults(
                response,
                prepareFlows(options, parseExtractFormat(request), "applications"));
    }
