...
@RestController
@RequestMapping("/data-extract/process-diagram/")
public class ProcessDiagramExtractorController {
    ...
    @Autowired
    public ProcessDiagramExtractorController(DSLContext dsl) {
        this.dsl = dsl;
    }
    ...
    public void export(
        ...
        writeExtract(
                "process-diagram-" + diagramId,
                prepareExtract(diagramId), request, response);
    }
