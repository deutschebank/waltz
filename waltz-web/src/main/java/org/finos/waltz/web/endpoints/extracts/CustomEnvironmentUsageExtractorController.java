...
// import org.finos.waltz.web.WebUtilities; // No longer needed
...
import static org.finos.waltz.web.endpoints.extracts.DirectQueryBasedExtractorUtilities.writeAsMultiSheetExcel;
import static org.jooq.lambda.tuple.Tuple.tuple;
// import static spark.Spark.get; // No longer needed


@RestController
public class CustomEnvironmentUsageExtractorController {
    ...
    @GetMapping("/data-extract/custom-environment/kind/{kind}/id/{id}")
    public Object getCustomEnvironmentUsages(
            @PathVariable String kind,
            @PathVariable long id,
            HttpServletResponse response) throws IOException {

            EntityReference ref = ImmutableEntityReference.builder()
                .kind(EntityKind.valueOf(kind.toUpperCase()))
                .id(id)
                .build();
