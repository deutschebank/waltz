...
@RestController
@RequestMapping("/data-extract/measurable-category/")
public class MeasurableCategoryExtractorController  {

    private final DSLContext dsl;
    @Autowired
    public MeasurableCategoryExtractorController(DSLContext dsl) {
        this.dsl = dsl;
    }
    ...
    @GetMapping("flat/{id}")
    public Object extractFlat(HttpServletRequest request,
                              HttpServletResponse response,
                              @PathVariable("id") long categoryId) throws IOException {
        ...
        List<Field<String>> orderingFields = ListUtilities.map(levelFields, Tuple3::v1);
    ...
    @GetMapping("{id}")
    public Object extractParentChild(HttpServletRequest request,
                                     HttpServletResponse response,
                                     @PathVariable("id") long categoryId) throws IOException {
