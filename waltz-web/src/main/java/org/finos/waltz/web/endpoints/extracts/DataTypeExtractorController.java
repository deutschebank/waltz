...
@RestController
@RequestMapping("/data-extract/data-types/")
public class DataTypeExtractorController {
    ...
    @GetMapping()
    public void extractDataTypes(HttpServletRequest request, HttpServletResponse response) throws IOException {
        writeExtract(
                "data-types",
                prepareExtract(),
                request,
