...
public class SurveyRunExtractorController {
    ...
    @Autowired
    public SurveyRunExtractorController(DSLContext dsl) {
        this.dsl = dsl;
    }

    @GetMapping("/survey-run/{id}")
    public Object surveyRun(@PathVariable("id") long runId,
    ...
    @GetMapping("/survey-run/history/{id}")
    public Object surveyRunHistory(@PathVariable("id") long runId,
                                   HttpServletRequest request,
                                   HttpServletResponse response) throws IOException {
    ...
    @GetMapping("/survey-run-response/instance/{id}")
    public Object surveyInstanceResponses(@PathVariable("id") long instanceId,
                                          HttpServletRequest request,
                                          HttpServletResponse response) throws IOException {
    ...
    @GetMapping("/survey-run-response/{id}")
    public Object surveyRunResponses(@PathVariable("id") long runId,
                                     HttpServletRequest request,
                                     HttpServletResponse response) throws IOException {
    ...
    @GetMapping("/surveys/entity/{kind}/{id}")
    public Object surveysForEntity(@PathVariable("kind") String kind,
