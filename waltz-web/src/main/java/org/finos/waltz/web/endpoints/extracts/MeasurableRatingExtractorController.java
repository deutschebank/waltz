...
@RestController
@RequestMapping("/data-extract/measurable-rating")
public class MeasurableRatingExtractorController  {
    ...
    @Autowired
    public MeasurableRatingExtractorController(DSLContext dsl) {
        this.dsl = dsl;
    }

    @PostMapping("/{id}")
    public Object registerRatingsExtract(@PathVariable("id") long categoryId,
                                       @RequestBody IdSelectionOptions selectionOpts,
    ...
    @PostMapping("/unmapped/{id}")
    public void registerUnmappedAllocationsExtract(@PathVariable("id") long categoryId,
                                                   @RequestBody IdSelectionOptions selectionOpts,
                                                   HttpServletRequest request,
                                                   HttpServletResponse response) throws IOException {
