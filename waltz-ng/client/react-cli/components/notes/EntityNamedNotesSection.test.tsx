...
const mockNoteTypes = [
    { entity: { id: 1, name: "General", description: "General Note" }, operations: ["ADD", "UPDATE", "REMOVE"] },
    { entity: { id: 2, name: "Audit", description: "Audit Note" }, operations: ["ADD", "UPDATE"] },
];

const mockNotes = [
    { note: { id: 101, namedNoteTypeId: 1, noteText: "This is a general note.", entityReference: mockParentEntityRef }, type: mockNoteTypes[0].entity, operations: mockNoteTypes[0].operations },
];
...
describe("EntityNamedNotesSection", () => {
    ...
    it("should show the removal confirmation when 'Delete' is clicked", async () => {
        ...
        expect(screen.getByText("Are you sure you would like to remove this note?")).toBeInTheDocument();
        expect(screen.getByText("This is a general note.")).toBeInTheDocument();
    });
    ...
    it("should call the save mutation when creating a new note", async () => {
        ...
        const textarea = screen.getByPlaceholderText("Enter note text here. Markdown formatting is supported.");
