...
const ActorListView = () => {
  ...
  return (
    <div>
      <PageHeader icon="user-circle" name="Actor List" breadcrumbs={breadCrumbsConfig} />
          ...
          <div className="waltz-display-section">
            <div className="row">
              <div className="col-sm-12">
                ...
                <br />
                <div
                  className="help-block pull-right small"
